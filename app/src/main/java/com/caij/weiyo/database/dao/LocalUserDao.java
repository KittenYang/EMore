...
public class LocalUserDao extends AbstractDao<LocalUser, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Weibo_json = new Property(25, String.class, "weibo_json", false, "WEIBO_JSON");
        public final static Property Allow_all_comment = new Property(26, Boolean.class, "allow_all_comment", false, "ALLOW_ALL_COMMENT");
        public final static Property Avatar_large = new Property(27, String.class, "avatar_large", false, "AVATAR_LARGE");
        public final static Property Avatar_hd = new Property(28, String.class, "avatar_hd", false, "AVATAR_HD");
        public final static Property Verified_reason = new Property(29, String.class, "verified_reason", false, "VERIFIED_REASON");
        public final static Property Follow_me = new Property(30, Boolean.class, "follow_me", false, "FOLLOW_ME");
        public final static Property Online_status = new Property(31, Integer.class, "online_status", false, "ONLINE_STATUS");
        public final static Property Bi_followers_count = new Property(32, Integer.class, "bi_followers_count", false, "BI_FOLLOWERS_COUNT");
        public final static Property Lang = new Property(33, String.class, "lang", false, "LANG");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LOCAL_USER\" (" + //
                ...
                "\"WEIBO_JSON\" TEXT," + // 25: weibo_json
                "\"ALLOW_ALL_COMMENT\" INTEGER," + // 26: allow_all_comment
                "\"AVATAR_LARGE\" TEXT," + // 27: avatar_large
                "\"AVATAR_HD\" TEXT," + // 28: avatar_hd
                "\"VERIFIED_REASON\" TEXT," + // 29: verified_reason
                "\"FOLLOW_ME\" INTEGER," + // 30: follow_me
                "\"ONLINE_STATUS\" INTEGER," + // 31: online_status
                "\"BI_FOLLOWERS_COUNT\" INTEGER," + // 32: bi_followers_count
                "\"LANG\" TEXT);"); // 33: lang
    }
    ...
    public LocalUser readEntity(Cursor cursor, int offset) {
        LocalUser entity = new LocalUser( //
            ...
            cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25), // weibo_json
            cursor.isNull(offset + 26) ? null : cursor.getShort(offset + 26) != 0, // allow_all_comment
            cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27), // avatar_large
            cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28), // avatar_hd
            cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29), // verified_reason
            cursor.isNull(offset + 30) ? null : cursor.getShort(offset + 30) != 0, // follow_me
            cursor.isNull(offset + 31) ? null : cursor.getInt(offset + 31), // online_status
            cursor.isNull(offset + 32) ? null : cursor.getInt(offset + 32), // bi_followers_count
            cursor.isNull(offset + 33) ? null : cursor.getString(offset + 33) // lang
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, LocalUser entity, int offset) {
        ...
        entity.setWeibo_json(cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25));
        entity.setAllow_all_comment(cursor.isNull(offset + 26) ? null : cursor.getShort(offset + 26) != 0);
        entity.setAvatar_large(cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27));
        entity.setAvatar_hd(cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28));
        entity.setVerified_reason(cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29));
        entity.setFollow_me(cursor.isNull(offset + 30) ? null : cursor.getShort(offset + 30) != 0);
        entity.setOnline_status(cursor.isNull(offset + 31) ? null : cursor.getInt(offset + 31));
        entity.setBi_followers_count(cursor.isNull(offset + 32) ? null : cursor.getInt(offset + 32));
        entity.setLang(cursor.isNull(offset + 33) ? null : cursor.getString(offset + 33));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(LocalUser entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
