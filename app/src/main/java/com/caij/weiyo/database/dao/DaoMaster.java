...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        FriendWeiboDao.createTable(db, ifNotExists);
        UserWeiboDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        FriendWeiboDao.dropTable(db, ifExists);
        UserWeiboDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(FriendWeiboDao.class);
        registerDaoClass(UserWeiboDao.class);
