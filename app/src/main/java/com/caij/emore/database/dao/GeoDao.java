 ...
 * DAO for table "GEO".
*/
public class GeoDao extends AbstractDao<Geo, String> {

    public static final String TABLENAME = "GEO";

    /**
     * Properties of entity Geo.<br/>
    ...
    */
    ...
    public GeoDao(DaoConfig config) {
        super(config);
    }
    
    public GeoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GEO\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GEO\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Geo entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Geo readEntity(Cursor cursor, int offset) {
        Geo entity = new Geo( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Geo entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(Geo entity, long rowId) {
        return entity.getId();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(Geo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
